...
import { getUserAddress } from "@/modules/fetch/user";
    ...
    const fetchProducts = async () => {
      try {
        if (typeof window !== "undefined") {
          ...
          if (storedUserId) {
            const response = await getUserAddress(storedUserId);
        ...
        {user && user.map((user) => (
              ...
              <div>
                <div class="space-y-2 text-gray-800 dark:text-gray-400 leading-loose hidden sm:block">
                  ...
                  City: {user.city.city_name} <br />
                  Province: {user.province.province_name} <br />
                </div>
                {/* <div id="contact-details" class="space-y-2 text-gray-900 dark:text-white font-medium leading-loose">
                  jl in aja <br />
                  bantul <br />
